          ...
          >
            ...
            >
              ...
              <div className="w-full md:w-80 bg-white border-r border-slate-200 flex flex-col h-[40vh] md:h-full flex-shrink-0">
                ...
                <div className="flex-1 overflow-y-auto px-4 py-4 space-y-1 custom-scrollbar-light" data-lenis-prevent>
                  <button
                ...
                {bookmarks.length > 0 && (
                  <div className="p-6 border-t border-slate-100 bg-slate-50/50">
                    ...
                    <div className="space-y-2 max-h-36 overflow-y-auto custom-scrollbar-light" data-lenis-prevent>
                      {articles
              ...
              <div className="flex-1 flex flex-col h-[60vh] md:h-full relative bg-white">
                ...
                {activeArticle ? (
                  ...
                  <div className="flex-1 flex flex-col overflow-hidden relative">
                    ...
                    >
                      <div className="max-w-2xl mx-auto">
                        ...
                        <h2 className="display-font text-3xl md:text-4xl font-extrabold text-slate-950 leading-tight mb-6">
                  ...
                  <div className="flex-1 flex flex-col overflow-hidden">
                    ...
                    {/* Scrollable list */}
                    <div className="flex-1 overflow-y-auto p-6 md:p-8 bg-[#F8FAFC] custom-scrollbar-light" data-lenis-prevent>
