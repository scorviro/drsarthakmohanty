          ...
          {navLinks.map((item) => {
            ...
            return (
              <a
                ...
                className="text-sm text-white hover:text-white/80 transition-colors relative group font-medium"
              >
                {item.name}
            ...
            <div className="flex flex-col px-6 space-y-6">
              ...
              <div className="pt-6 border-t border-white/10 flex flex-col space-y-6">
                <a
                  href={isHome ? "#book" : "/#book"}
                  onClick={(e) => handleNavClick(e, "book")}
                  className="bg-white text-[#019E88] px-6 py-3 rounded-full text-center font-medium shadow-md hover:shadow-lg transition-all"
                >
