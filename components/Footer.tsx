  ...
  return (
    <footer className="bg-[#019E88] pt-20 pb-10 border-t border-white/10 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex flex-col mb-6">
              ...
              <span className="text-xs text-white tracking-widest uppercase mt-1">
                {t("nav.logo_subtitle")}
              </span>
            </Link>
        ...
        <div className="pt-8 border-t border-white/20 flex flex-col md:flex-row items-center justify-between text-xs text-white gap-4">
          <div className="flex flex-col md:flex-row md:items-center gap-4 text-center md:text-left">
            ...
            <a
              ...
              className="inline-flex items-center space-x-2 text-white hover:opacity-90 transition-opacity font-medium justify-center"
            >
              <span>Website designed and developed by</span>
              <span className="w-5 h-5 bg-white rounded flex items-center justify-center shadow-sm">
                <svg className="w-2.5 h-2.5 text-black fill-current" viewBox="0 0 100 100">
                  <polygon points="50,22 15,80 85,80" />
                </svg>
              </span>
              <span className="text-white font-bold lowercase tracking-wide text-sm">scorviro</span>
            </a>
          </div>
