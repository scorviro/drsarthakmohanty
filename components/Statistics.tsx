    ...
    <section className="py-24 bg-[#FAFAFA] relative overflow-hidden" id="patient-ratings">
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-24">
          <Counter target={1500} suffix="+" title={t("statistics.patients_treated")} />
              ...
              <div className="flex items-center space-x-3 mb-6 pb-4 border-b border-slate-100">
                ...
                <div>
                  <h3 className="font-bold text-lg text-slate-900 leading-tight flex items-center space-x-1.5">
                    <span>{t("statistics.modal_title")}</span>
                  </h3>
                  <div className="flex items-center space-x-1 text-[11px] text-[#4285F4] font-semibold">
                    <CheckCircle2 size={12} className="text-emerald-500 fill-white" />
                    <span>{t("statistics.posting_as")}: {currentUser?.email}</span>
                  </div>
                </div>
              </div>
      ...
      {/* Google Login popup Modal Trigger */}
      <AnimatePresence>
        {isAuthModalOpen && (
          <GoogleAuthModal
            ...
            detectedNgrokUrl={detectedNgrokUrl}
          />
        )}
      </AnimatePresence>
