...
export default function HeroSection() {
  ...
  return (
    <section 
      ref={containerRef}
      className="relative min-h-[calc(100vh-96px)] flex items-center pt-24 pb-16 lg:py-0 overflow-hidden"
    >
      {/* Ambient Background */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <motion.div style={{ y, opacity, willChange: "transform, opacity" }} className="max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6">
              ...
              <a href={`https://wa.me/${t("common.phone_val").replace(/[^\d]/g, '')}`} className="w-full sm:w-auto flex items-center justify-center space-x-2 px-8 py-4 rounded-full font-medium glass-panel hover:bg-slate-50/50 transition-all text-slate-900 border border-slate-200">
            ...
            <div className="absolute inset-0 flex items-center justify-center z-10">
              <div className="w-[400px] h-[500px] relative rounded-[60px] border border-slate-200/80 overflow-hidden shadow-2xl bg-slate-50 flex items-center justify-center group-hover:border-brand-teal/30 transition-colors duration-500">
                <Image 
                  ...
                  alt="Dr. Sarthak Kumar Mohanty - Senior Radiation Oncologist in Rajkot, Gujarat" 
